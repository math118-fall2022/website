...
Now let's use the `chipotle` data to create a visualize the locations of each store. Copy and paste your code from Exercise 1 and then replace the underscores appropriately. 
...
Copy and paste the plotting code in Exercise 4 below. Using the `brewer.pal()` function from the library `RColorBrewer` (you may need to install it), choose a different color palette. You must pass in two arguments:
