---
title: "HW 01 - Hello R!"
subtitle: "due Tuesday, 9/20 at 11:59pm"
output: 
  tufte::tufte_html:
    css: "./math118-hw.css"
...
- Go to the Math 118 organization on GitHub (http://www.github.com/math118-fall2022). Click on the repo with the prefix **hw-01-hello-r-**. It contains the starter documents you need to complete the lab.

- Click on the green **Code** button, select the second option "Open with GitHub Desktop"

```{r echo = F, fig.align="center", out.width="70%"}
knitr::include_graphics("img/01-hello-r/clone.png")
```
...
```{r echo = F, fig.align="center", out.width="70%"}
knitr::include_graphics("img/01-hello-r/find_folder.png")
```
...
You may need to install the `datasauRus` package by running the following in your **console** (watch out for capitalization):
...
<div class = "commit"> You should pause again, knit, and commit changes with the commit message "Added answer for Ex 4", and push.
</div>
...
<div class = "commit"> Commit all remaining changes, use the commit message "Done with HW 1!" and push. 
</div>

# Submission


In this class, we'll be submitting .pdf documents to Canvas. Once you are fully satisfied with your homework, **Knit to .pdf** to create a .pdf document. You may notice that the formatting/theme of the report has changed -- this is expected. *Refer to the file in the 9/20 HW section of the schedule on the course website for help on how to knit to PDF!*
