...
Go to the course GitHub organization and locate your HW 02 repo, which should be named `hw-02-plastic-waste-[GITHUB USERNAME]`. Grab the URL of the repo, and clone it in RStudio. Refer to HW 01 for step-by-step for cloning a repo and creating a new RStudio project.
...
<div class = "commit">
Now is a good time to knit, commit and push your changes to GitHub with a short, informative commit message. Make sure to commit and push all changed files so that your Git pane is cleared up afterwards.
</div>
