...
The data may be found by cloning your **hw-05-durham-**  repository available in the [GitHub course organization](https://github.com/math118-fall2022).

Today's data comes from the City of Durham, North Carolina's annual Resident Satisfaction 
Survey for 2018 (more information accessible 
[**here**](https://www.dconc.gov/government/departments-a-e/county-manager/city-county-resident-survey)). In particular, the `durham_survey` dataset contains data from 608 Durham residents on the survey questions below. Assume that the data are representative of Durham residents and may be generalized to the wider population of all city residents.
...
5 being "highly satisfied." A value of 9 indicates that the subject responded with N/A.
...
the fire department among durham residents in 2018. Use at least 1,000 bootstrap samples. Make sure your interval is *reproducible*.
