...
- Read about how this actually played out and Twitter’s response when presented with evidence of bias in their cropping algorithm.
...
knitr::include_graphics("img/09/election-2016-county.png")
```
...
```{r echo=FALSE, out.width=900}
  knitr::include_graphics("img/09/cairo-what-matters.png")
```
