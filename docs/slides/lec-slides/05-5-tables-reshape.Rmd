...
- Note, there is not an easy way to paginate. We can instead do ths following:
...
- The variable `group` in the `exibble` data, 
...
- Each row should represent a single `country`
...
- Takes two arguments:
  ...
  - `names_from`: the name of the variable(s) to get the name of the output column
  
  - `values_from`: the name of the variable(s) to get the cell values from
...
- Takes three arguments:
  ...
  - `cols`: specify which columns to pivot into longer format
