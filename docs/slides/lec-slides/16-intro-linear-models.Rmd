...
[Click here](https://github.com/sta199-summer2021/website/tree/master/docs/slides/lec-slides/paris_paintings_codebook.pdf) for Paris Paintings codebook

.pull-left[
```{r echo = F, out.width = "30%", fig.cap = "Sandra van Ginhoven"}
knitr::include_graphics("img/17/sandra-van-ginhoven.png")
```
]

.pull-right[
```{r echo = F, out.width = "30%", fig.cap = "Hilary Coe Cronheim"}
knitr::include_graphics("img/17/hilary-coe-cronheim.png")
```
]
...
knitr::include_graphics("img/17/auction-video.png")
```
...
```{r echo = F, out.width = "70%"}
knitr::include_graphics("img/17/old-auction.png")
```
...
```{r echo = F, out.width = "70%"}
knitr::include_graphics("img/17/auction-trend-paris.png")
```
...
knitr::include_graphics("img/17/depart-pour-la-chasse.png")
```
...
.pull-left[
```{r echo = F, out.width = "70%"}
knitr::include_graphics("img/17/auction-catalogue.png")
```
]
